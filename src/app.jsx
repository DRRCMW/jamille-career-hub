...
/* ─── JOB POOL: VERIFIED NOTARY PLATFORM SIGNUPS (April 2026 — All links live-tested) ─── */
const NOTARY_POOL = [
  {
    id:"n01", company:"Proof / Notarize (RON)", logo:"Pr",
    title:"PA Online Notary – Notarize Network",
    location:"Remote – PA (RON)", salary:"$25–$50/notarization", type:"Independent Contractor", tag:"notary", match:98,
    about:"Proof (formerly Notarize) is the #1 RON platform in the US. PA notaries with an eNotary commission can join the Notarize Network and take on-demand RON sessions 24/7 from home. PA is an approved on-demand state.",
    description:"Join the Notarize Network to perform remote online notarizations for real estate closings, legal documents, financial transactions, and individuals nationwide. Work whenever you want from home.",
    requirements:["Valid PA Notary Public Commission","PA eNotary/RON authorization from PA Dept of State","NNA ID number (free account)","NNA Notary Signing Agent certification"],
    niceToHave:["Real estate closing experience","RON platform experience","Spanish language skills"],
    applyUrl:"https://www.notarize.com/resources/notary-sign-up",
    websiteUrl:"https://www.notarize.com"
  },
  {
    id:"n02", company:"Snapdocs", logo:"Sd",
    title:"Signing Agent – Join Notary Network",
    location:"Philadelphia Metro + Remote RON", salary:"$75–$200/signing", type:"Independent Contractor", tag:"notary", match:96,
    about:"Snapdocs is the largest digital closing platform in the US. Hundreds of title companies and signing services use Snapdocs to find signing agents. Free to join — Snapdocs Verified agents get 5x more business.",
    description:"Create a free Snapdocs account to receive loan signing assignments from title companies and lenders in the Philadelphia area. Manage your signings, get paid via VendorPay direct deposit.",
    requirements:["Valid PA Notary Commission","E&O Insurance (background check for Verified status)","Reliable transportation and printer/scanner","NNA certification recommended"],
    niceToHave:["PA eNotary/RON capability","Snapdocs Verified status (more assignments)","High acceptance rate and 5-star rating"],
    applyUrl:"https://www.snapdocs.com/join-notary-network",
    websiteUrl:"https://www.snapdocs.com"
  },
  {
    id:"n03", company:"Signing Services of America (SSA)", logo:"SSA",
    title:"Notary Signing Agent – Philadelphia Metro",
    location:"Philadelphia Metro", salary:"$75–$150/signing", type:"Independent Contractor", tag:"notary", match:94,
    about:"Signing Services of America is a highly rated national signing service that pays within 30 days and personally contacts title companies on your behalf. PA notaries praise their professionalism and consistent work.",
    description:"Sign up directly to SSA's notary portal to receive loan signing assignments in the Philadelphia area. SSA handles the scheduling and coordinates with title companies so you can focus on closings.",
    ...
    niceToHave:["NNA Certification","High availability including short-notice signings","Familiarity with mortgage documents"],
    applyUrl:"https://ssa.signingservicesofamerica.com/signup",
    websiteUrl:"https://signingservicesofamerica.com"
  },
  {
    id:"n04", company:"NotaryGo", logo:"NG",
    title:"Signing Agent – NotaryGo Network",
    location:"Philadelphia Metro", salary:"$75–$175/signing", type:"Independent Contractor", tag:"notary", match:92,
    about:"NotaryGo has been in business since 1986 and has completed 2.5+ million loan signings. One of the industry's largest signing networks. PA notaries can register directly on their Pro portal.",
    description:"Register on the NotaryGo platform to receive real estate closing and loan signing assignments in the Philadelphia area. Primary agents get paid weekly and receive priority signing opportunities.",
    requirements:["PA Notary Public Commission","Signing Agent certification (NNA preferred)","E&O Insurance","Valid driver's license and reliable transportation"],
    niceToHave:["10+ signings completed for Primary Agent status","PA eNotary commission","Availability at month-end (highest volume)"],
    applyUrl:"https://pro.notarygo.com/SignUp",
    websiteUrl:"https://www.notarygo.com"
  },
  {
    id:"n05", company:"NNA – Loan Signing Agent Certification", logo:"NNA",
    title:"PA Loan Signing Agent Certification",
    location:"Pennsylvania (Online Exam)", salary:"$75–$200/signing after cert.", type:"Certification", tag:"notary", match:99,
    about:"The NNA Loan Signing Agent Certification is required or strongly preferred by Snapdocs, SSA, NotaryGo, Proof, and most title companies. PA-specific certification page. Most platforms require this — do this first.",
    description:"Earn the NNA Notary Signing Agent certification including the exam and background screening. Once certified, you are listed on SigningAgent.com and qualify for all major signing platforms. Packages from $199.",
    requirements:["Valid PA Notary Public Commission","Pass NNA NSA Certification Exam","Pass NNA Background Screening","E&O Insurance (available through NNA)"],
    niceToHave:["Prior notary experience","Real estate or legal background","PA eNotary commission for RON work"],
    applyUrl:"https://www.nationalnotary.org/pennsylvania/signing-agent",
    websiteUrl:"https://www.nationalnotary.org"
  },
  {
    id:"n06", company:"NotaryResume.com", logo:"NR",
    title:"Notary Signing Agent – Free Listing",
    location:"Philadelphia Metro + Nationwide", salary:"$75–$150/signing", type:"Independent Contractor", tag:"notary", match:88,
    about:"NotaryResume.com (powered by SigningOrder) is the recommended platform for notaries from SigningOrder.com's own signup page. Free to join — create your notary profile and receive assignment requests from title companies.",
    description:"Create your free notary profile on NotaryResume.com to be found by title companies and signing services across the Philadelphia area and nationwide. Upload credentials and receive assignment notifications.",
    requirements:["PA Notary Public Commission","Signing Agent certification (recommended)","E&O Insurance","Reliable transportation"],
    niceToHave:["NNA certification for more assignment volume","RON capability for remote work","Professional bio and photo"],
    applyUrl:"https://www.notaryresume.com/signup",
    websiteUrl:"https://www.notaryresume.com"
  },
  {
    id:"n07", company:"Nationwide Signing Services (NSS)", logo:"NSS",
    title:"Notary Signing Agent – Join NSS Team",
    location:"Philadelphia Metro + Nationwide", salary:"$75–$175/signing", type:"Independent Contractor", tag:"notary", match:86,
    about:"NSS (Nationwide Signing Services) is a highly reviewed signing service known for training support, excellent customer service, and consistent work. They actively recruit PA notaries. Free to join.",
    description:"Join the NSS notary team to receive loan signing assignments. NSS provides a training walkthrough, strong support, and connects you with title companies and lenders nationwide.",
    requirements:["PA Notary Commission","Signing Agent certification preferred","E&O Insurance","Reliable transportation and printer"],
    niceToHave:["NNA certification","Professional communication skills","Real estate loan document experience"],
    applyUrl:"https://nssnotary.com/join/notary",
    websiteUrl:"https://nssnotary.com"
  },
  {
    id:"n08", company:"SigningAgent.com (NNA)", logo:"SA",
    title:"Get Listed on SigningAgent.com",
    location:"Philadelphia, PA + Nationwide", salary:"$75–$200/signing", type:"Independent Contractor", tag:"notary", match:95,
    about:"SigningAgent.com is the NNA's official directory — title companies and lenders search here to find NNA-certified signing agents. Getting listed here is one of the most effective ways to generate consistent PA signing work.",
    description:"NNA-certified signing agents get automatically listed on SigningAgent.com, used by hundreds of title companies nationwide. Your profile includes your credentials, background screening status, and service area.",
    requirements:["NNA Loan Signing Agent Certification","NNA Background Screening (passed)","Valid PA Notary Commission","E&O Insurance"],
    niceToHave:["NNA Membership (for full profile features)","PA eNotary commission","High volume signing history"],
    applyUrl:"https://www.signingagent.com/services",
    websiteUrl:"https://www.signingagent.com"
  },
];
...
const NOTARY_RESOURCES = [
  ...
  { title:"Proof (formerly Notarize)", desc:"Join the RON platform for on-demand remote notarizations", url:"https://www.notarize.com/resources/notary-sign-up", tag:"RON" },
